#!/usr/bin/env python3
"""
Génération d'une surface 2D à partir de la géométrie d'un modèle Crue10
Variables :
* FOND
* FROTTEMENT
* IS_LIT_ACTIF
...
Particularités :
- SectionProfil: les sections situées aux extrémités (amont/aval) des branches sont replacées pour correspondre
...
# Inputs
parser_infiles = parser.add_argument_group("Modèle Crue10 à traiter")
